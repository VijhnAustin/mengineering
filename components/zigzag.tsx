...
import FeatImage01 from '@/public/images/mengi1.jpg'
import FeatImage02 from '@/public/images/mengi2.jpg'
import FeatImage03 from '@/public/images/mengi3.jpg'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <h1 className="h2 mb-4">One engineering firm, unlimited solutions</h1>
