      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1">Welcome to Marcelin Engineering</h1>
          </div>
          ...
          <div className="max-w-sm mx-auto">
            ...
            <form>
              ...
              <div className="text-sm text-gray-500 text-center">
                I agree to be contacted by Marcelin Engineering<Link href="#" className="underline text-gray-400 hover:text-gray-200 hover:no-underline transition duration-150 ease-in-out">Privacy Policy</Link>.
              </div>
